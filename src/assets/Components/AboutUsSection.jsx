...
import AboutImageTwo from "../Images/AboutImageTwo.png"
import AboutImageThree from "../Images/AboutImageThree..png"
...
const AboutUsSection = () => {
  ...
  return (
    <section className="bg-black text-white py-12 px-4 md:px-16">
      <div className="mb-12">
        <button className="flex items-center gap-2 bg-purple-700 hover:bg-purple-800 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-md AboutImageOne">
          <FaInfoCircle />
          About Us
        </button>
      </div>
